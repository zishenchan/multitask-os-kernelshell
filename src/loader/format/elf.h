...
#include <stdint.h> 
#include <stddef.h>
// all the content is in manual pages(linuxfoundation.org/elf), the elf loader
...
// define elf class and data encoding
...
struct elf32_sym
{
    elf32_word st_name;// index in the string table
    elf32_addr st_value;
    elf32_word st_size;
